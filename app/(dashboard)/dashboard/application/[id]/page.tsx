...
export const Application:FC<pageProps> = ({params}) =>{
    ...
    <main
      className="flex items-center justify-center px-1 py-1 sm:px-1 lg:col-span-7 lg:px-16 lg:py-1 xl:col-span-6 h-full">
        ...
        <form  className="flex flex-col gap-5 bg-gray-50 p-4 md:p-16 rounded-md h-fit w-full md:w-4/5">
          ...
          <div className="col-span-6 sm:col-span-3 mx-auto md:mx-0">
            <label
              htmlFor="document"
          ...
          {Boolean(application?.admin_pdf)&&<div className="col-span-6 sm:col-span-3 mx-auto md:mx-0">
            <label
              htmlFor="document"
              className="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
            >
          ...
          <div className="w-full flex justify-center items-center mt-14">
            <Button disabled variant={"primary"} className="mx-auto font-bold"><span>Update</span></Button>
          </div>
